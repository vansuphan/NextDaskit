  ...
  return (
    <MasterPage>
      <BasicLayout padding="50px">
        ...
        `}</style>
        <h2>Example of HorizontalList</h2>
        ...
        <HorizontalList type={ListType.START} wrap={true}>
          ...
          <h3 className="space5px" style={{ width: "150px" }}>Item 2</h3>
          <h3 className="space5px" style={{ width: "200px" }}>Item 3</h3>
          <h3 className="space5px" style={{ width: "350px" }}>Item 4</h3>
          <h3 className="space5px" style={{ width: "250px" }}>Item 4</h3>
          <h3 className="space5px" style={{ width: "300px" }}>Item 4</h3>
        </HorizontalList>
      </BasicLayout>
      ...
      <BasicLayout padding="50px">
        ...
        <VerticalList
          align={VerticalListAlign.CENTER}
          style={{ height: "200px" }}
        >
          <ListItem>
            <h3>Item 1</h3>
