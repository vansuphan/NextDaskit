...
export class DrawingLayerResizeMode {
  static get MANUAL() { return "MANUAL" };
  static get FIT_TO_BROWSER() { return "FIT_TO_BROWSER" };
  static get FIT_TO_PARENT() { return "FIT_TO_PARENT" };
}

export class DrawingLayerInteractionMode {
